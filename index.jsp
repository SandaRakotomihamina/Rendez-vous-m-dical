        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="WebContent/login-patient.jsp">Connexion Patient</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="WebContent/login-medecin.jsp">Connexion Médecin</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <a href="WebContent/login-patient.jsp" class="btn btn-primary btn-lg btn-block w-100">
                                    <i class="fas fa-user"></i> Patient
                                </a>
                                <p class="small mt-2">Prenez rendez-vous avec un médecin</p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <a href="WebContent/login-medecin.jsp" class="btn btn-success btn-lg btn-block w-100">
